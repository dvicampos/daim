...
exports.casos = (req, res) => {
    const query = `
        ...
        GROUP BY 
            casos.id, clientes.nombre, encargados.nombre, casos.descripcion, casos.estado, casos.fecha_entrega, casos.fecha_devolucion
    `;
...
exports.generarPDF = (req, res) => {
    ...
    // Obtener el caso específico por su ID
    db.query(`SELECT 
                casos.id, 
                clientes.nombre AS cliente_nombre,
                clientes.apellido AS cliente_apellido, 
        ...
        // URL del caso
        const casoUrl = `https://mexwebtechnological.com/casos/ver/${caso.id}`; // Cambia por tu dominio real
